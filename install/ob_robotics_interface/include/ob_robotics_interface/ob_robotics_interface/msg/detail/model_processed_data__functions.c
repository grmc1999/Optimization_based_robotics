...
ob_robotics_interface__msg__ModelProcessedData__init(ob_robotics_interface__msg__ModelProcessedData * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->timestamp)) {
    ob_robotics_interface__msg__ModelProcessedData__fini(msg);
    return false;
  }
  // values
...
ob_robotics_interface__msg__ModelProcessedData__create(void)
{
  ...
  ob_robotics_interface__msg__ModelProcessedData * msg = (ob_robotics_interface__msg__ModelProcessedData *)allocator.allocate(sizeof(ob_robotics_interface__msg__ModelProcessedData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ob_robotics_interface__msg__ModelProcessedData));
  bool success = ob_robotics_interface__msg__ModelProcessedData__init(msg);
  if (!success) {
...
ob_robotics_interface__msg__ModelProcessedData__Sequence__init(ob_robotics_interface__msg__ModelProcessedData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ob_robotics_interface__msg__ModelProcessedData * data = NULL;

  if (size) {
    data = (ob_robotics_interface__msg__ModelProcessedData *)allocator.zero_allocate(size, sizeof(ob_robotics_interface__msg__ModelProcessedData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ob_robotics_interface__msg__ModelProcessedData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ob_robotics_interface__msg__ModelProcessedData__fini(&data[i - 1]);
      }
...
ob_robotics_interface__msg__ModelProcessedData__Sequence__fini(ob_robotics_interface__msg__ModelProcessedData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ob_robotics_interface__msg__ModelProcessedData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ob_robotics_interface__msg__ModelProcessedData__Sequence * array = (ob_robotics_interface__msg__ModelProcessedData__Sequence *)allocator.allocate(sizeof(ob_robotics_interface__msg__ModelProcessedData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ob_robotics_interface__msg__ModelProcessedData__Sequence__init(array, size);
  if (!success) {
...
ob_robotics_interface__msg__ModelProcessedData__Sequence__destroy(ob_robotics_interface__msg__ModelProcessedData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ob_robotics_interface__msg__ModelProcessedData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ob_robotics_interface__msg__ModelProcessedData__Sequence__are_equal(const ob_robotics_interface__msg__ModelProcessedData__Sequence * lhs, const ob_robotics_interface__msg__ModelProcessedData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ob_robotics_interface__msg__ModelProcessedData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ob_robotics_interface__msg__ModelProcessedData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ob_robotics_interface__msg__ModelProcessedData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ob_robotics_interface__msg__ModelProcessedData * data =
      (ob_robotics_interface__msg__ModelProcessedData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ob_robotics_interface__msg__ModelProcessedData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ob_robotics_interface__msg__ModelProcessedData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ob_robotics_interface__msg__ModelProcessedData__copy(
